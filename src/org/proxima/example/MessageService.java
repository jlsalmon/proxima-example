...
public class MessageService extends Service
{
    ...
    private void showNotification(String tickerStr, Bundle extras)
    {
        ...
        // TODO: deprecated, use Notification.Builder instead
        notification = new Notification(R.drawable.ic_launcher, tickerStr,
...
//        startActivity(intent);
        ...
        // NOTE: Use a unique notification id to ensure a new pending intent is
        // created.

        // pending intent to launch main activity if the user selects
        // notification
        ...
        notification.setLatestEventInfo(this, "Wireless AdHoc", tickerStr,
                pendingIntent);

        // NOTE: Use a unique notification id, otherwise an existing
        // notification with the same id will be replaced.
    ...
    private class MessageListenerThread extends Thread
    {
        ...
        public void run()
        {
            ...
            try
            {
                // bind to local machine; will receive broadcasts and directed
                // messages
